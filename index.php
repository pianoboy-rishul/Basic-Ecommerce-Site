...
<nav class="navbar navbar-transparent">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="http://localhost/Ecommerce/index.php" style="color: black;"><b>Home</b></a></li>
      ...
      <li class="active"><a href="https://www.instagram.com/_pianoboy_rishul_/" target="_blank" class="fa fa-instagram"></a></li>
      <li class="active"><a href="https://www.linkedin.com/in/rishul-ghosh-86368a1a8/" target="_blank" class="fa fa-linkedin"></a></li>
      <li class="active"><a href="https://www.youtube.com/channel/UCoE_HPpS7Eg2bmAR81_RjzA" target="_blank" class="fa fa-youtube"></a></li>
      <li class="active"><a href="https://www.facebook.com/rishul.ghosh.3" target="_blank" class="fa fa-facebook"></a></li>
      </li>
    </ul>
  </div>
</nav><br>
<div class="cont">
  ...
  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;<button type="submit" class="btn" onclick="myFunction()"><b>Sign In to Start Shopping</b></button><br><br>
  <script>
    function myFunction() {
      window.open("http://localhost/Ecommerce/login/login.php")
    }
  </script>
</div><br>
